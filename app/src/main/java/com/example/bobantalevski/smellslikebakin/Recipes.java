...
public class Recipes {
    public static String[] names = new String[]{"Crepes","Pancakes","Scones","French Toast", "Muffins",
            "Waffles","Toast", "Banana Bread" ,"German Pancakes","Beignets", "Blintzes", "Croissants",
            "Biscuits", "Cinnamon Rolls", "Coffee Cake", "Donut Holes", "Bagels", "English Muffin",
            "Baguette", "Danish"};

    public static int[] resourceIds = new int[]{R.drawable.crepes, R.drawable.pancakes,
            R.drawable.scones, R.drawable.french_toast, R.drawable.muffins, R.drawable.waffles,
            R.drawable.toast, R.drawable.banana_bread, R.drawable.german_pancakes,
            R.drawable.beignets, R.drawable.blintzes, R.drawable.croissants, R.drawable.biscuits,
            R.drawable.cinnamon_rolls, R.drawable.coffee_cake, R.drawable.donut_holes,
    ...
    public static String[] ingredients = new String[]{
            ...
            "1 slice of bread`1 toaster", "2 cups all-purpose flour`1 tsp baking soda`dash of salt`1 cup sugar`1/4 cup salted butter`2 large eggs`3 mashed bananas`1 cup plain or vanilla greek yogurt`1 tsp vanilla extract",
